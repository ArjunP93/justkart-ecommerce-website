...
router.get('/edit-category/:id',authentication.adminAuth,admincontrol.get_EditCategory)
router.post('/edit-category',authentication.adminAuth,admincontrol.post_EditCategory)
...
router.get("/delete-category",authentication.adminAuth,adminControl.deleteCategory)



router.get('/all-orders',authentication.adminAuth,admincontrol.get_all_orders)

router.get('/view-admin-order-expand/:id',admincontrol.get_adminOrdersExpand)

router.post('/update-status',authentication.adminAuth,adminControl.updateProductStatus)
...
router.get('/delete-banner/:id',authentication.adminAuth,adminControl.delete_banner)
...
router.get('/delete-coupon/:id',authentication.adminAuth,adminControl.delete_coupon)
...
router.post('/sales-report',authentication.adminAuth,adminControl.postSalesReport)
